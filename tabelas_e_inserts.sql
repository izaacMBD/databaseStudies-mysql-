...
create table tbl_produto(
	...
	constraint pmk_cod_prod primary key(cod_produto)
);
...
('Arroz', 'Arroz agulhinha tipo 1', 'SC', 10,2,28, 12.50),
('Feijão', 'Feijão carioquinha com casca', 'SC', 25,5,60, 7.50),
('Macarrão', 'Macarrão Adria espaguete', 'PC', 50,10,80, 5.50),
('Óleo', 'Óleo Lisa', 'LT', 15,18,45, 6.50), 
('Vinagre', 'Vinagre Castelo', 'GR', 30,10,50, 7.89),
('Batata', 'Batata lavada', 'KG', 100, 50, 200, 4.50),
('Tomate', 'Tomate vermelho', 'KG', 88,8,160, 6.90),
('Cebola', 'Cebola com casca', 'KG', 50,5,100, 6.99),
('Leite', 'Leite Leco', 'CX', 25,18,90, 2.50),
('Café', 'Café do Ponto', 'SC', 500,100,200, 11.50),
('Açúcar', 'Açúcar cristal', 'KG', 200, 30, 300, 4.75),
('Farinha', 'Farinha de trigo', 'KG', 150, 20, 250, 3.80),
('Manteiga', 'Manteiga Aviação', 'PC', 40, 10, 70, 9.99),
('Queijo', 'Queijo prato fatiado', 'KG', 20, 5, 50, 25.00),
('Presunto', 'Presunto Sadia', 'KG', 30, 10, 40, 20.00),
('Suco', 'Suco de laranja integral', 'LT', 60, 15, 100, 8.00),
('Salsicha', 'Salsicha Perdigão', 'PC', 100, 25, 150, 12.00),
('Papel Toalha', 'Papel toalha Scott', 'ROLO', 15, 5, 30, 5.25),
('Sabão', 'Sabão em pó Omo', 'KG', 75, 20, 100, 10.50),
('Detergente', 'Detergente Ypê', 'LT', 45, 10, 60, 3.20),
('Shampoo', 'Shampoo Seda', 'LT', 20, 5, 30, 7.80),
('Condicionador', 'Condicionador Dove', 'LT', 22, 5, 35, 8.50),
('Toalha', 'Toalha de banho', 'UN', 30, 10, 50, 15.00),
('Cerveja', 'Cerveja Skol', 'LT', 80, 20, 120, 3.90),
('Vinho', 'Vinho Cabernet Sauvignon', 'GAR', 12, 5, 20, 45.00);

insert into tbl_produto (nome_produto, desc_produto, unid_medida, estoque_atual, estoque_min, estoque_max, valor) values
('Arroz-chinês', 'Arroz papado tipo 1', 'SC', 3,2,28, 12.50);

/*
	TABELA DE PEDIDO
*/
insert into tbl_pedido (data_pedido, data_entrega, cod_cliente) values
('2024-08-19', '2024-08-20', 1),
('2024-07-18', '2024-07-19', 2),
('2024-06-17', '2024-06-18', 3),
('2024-05-16', '2024-05-17', 4),
('2024-04-15', '2024-04-16', 5),
('2024-03-14', '2024-03-15', 6),
('2024-02-13', '2024-02-14', 7),
('2024-01-12', '2024-01-13', 8),
('2023-12-11', '2023-12-12', 9),
('2023-11-10', '2023-11-11', 10);

insert into tbl_pedido (data_pedido, data_entrega, cod_cliente) value
('2024-08-19', '2024-08-20', 1);
/*
